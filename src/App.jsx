...
export default function App() {
  ...
  return (
    <>
      ...
      <ImageSection
        innerRef={setRef(5)} src={`${BASE}images/site/03-square.webp`} alt="Marktplatz"
        title="Marktplatz"
        onNext={() => scrollTo(6)} onBack={() => scrollTo(4)} n={6}
      />

      <ImageSection
        innerRef={setRef(6)} src={`${BASE}images/site/site-analysis.webp`} alt="Site analysis"
        title="Site Analysis" text={SITE_ANALYSIS_TEXT} textPosition="right"
        onNext={() => scrollTo(7)} onBack={() => scrollTo(5)} n={7}
      />

      <ImageSection
        innerRef={setRef(7)} src={`${BASE}images/site/current-perspective.webp`} alt="Current perspective"
        title="Current Perspective"
        onNext={() => scrollTo(8)} onBack={() => scrollTo(6)} n={8}
      />

      <TypewriterSection
        innerRef={setRef(8)} mode="fade" text={AIM_TEXT}
        followUp={{ title: 'Interactive Chat', subtitle: 'Coming soon' }}
      ...
      <CompareSliderSection
        innerRef={setRef(11)} eyebrow="Design Scenarios" title="Westhagen Plays"
        imageA={`${BASE}images/comparisons/westhagen-start.webp`} labelA="Start"
        imageB={`${BASE}images/comparisons/westhagen-plays.webp`} labelB="Westhagen Plays"
      ...
      <ExpansionSection
        innerRef={setRef(14)} onRestart={() => scrollTo(0)} onBack={() => scrollTo(13)} n={15}
      />
      </div>
    </>
  )
